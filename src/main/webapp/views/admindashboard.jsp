   ...
   <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p>Dummy Heading</p>
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Agencies</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="agencyRegister">Create Agenecy </a>
                        </li>
                        <li>
                            <a href="viewAgencies?pn=1">View Agencies</a>
                        </li>
                        <li>
                            <a href="#">Home 3</a>
                        </li>
