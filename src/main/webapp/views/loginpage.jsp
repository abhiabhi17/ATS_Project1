...
<div class="middle">
      <div class =mid-left">
       <div id="carouselExample1" class="carousel slide z-depth-1-half" data-ride="carousel"  style="width:200%;margin-left:30px;" >
...
<div class="container"  style="margin-left:1300px;margin-top:-400px" >
<div class="row" ">
    
		<form:form action="dashBoard" method="POST"  modelAttribute="login" id="userRegForm">
			<fieldset>
				<h2>Please Sign In</h2>
				<hr class="colorgraph">
				<div class="form-group">
				
				       <form:input path="email" class="form-control input-lg" placeholder="Email Address"/>
